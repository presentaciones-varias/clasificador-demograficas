...
::: {.incremental .medium-par}
- Como modelo se usó una red neural recurrente LSTM (Long Short-Term Memory), que es una arquitectura diseñada especialmente para aprender dependencias en datos en secuencia (ejemplo: una glosa de texto).
- Para mejorar el aprendizaje del modelo, se agregó una capa de word embedding...
  - TODO: BREVE DESCRIPCIÓN DE WORD EMBEDDINGS.
:::
